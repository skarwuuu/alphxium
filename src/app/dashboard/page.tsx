      ...
      <div className="mx-10 flex flex-row gap-10 min-h-[70vh] mb-10">
        <div className="flex flex-col items-start border-4 rounded-lg p-10 border-light gap-20 flex-1">
          <div className="flex flex-row items-center w-full">
            ...
            <Link href="/dashboard/borrow" className="font-space text-4xl font-semibold text-light hover:-translate-y-[0.15rem] duration-150"><FontAwesomeIcon icon={faArrowUpRightFromSquare} /></Link>
          </div>
          <div className="flex flex-col gap-20 w-full">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="font-space text-3xl ml-2 text-light selection:text-dark selection:bg-light">Amount of Currency</h3>
              <input type="number" className="bg-light text-dark text-xl font-space font-bold outline-none rounded-xl w-full p-4 selection:text-light selection:bg-dark"/>
            </div>
        ...
        <div className="flex flex-col items-start border-4 rounded-lg p-10 gap-16 border-light flex-1">
          <div className="flex flex-row items-center w-full">
            ...
            <Link href="/dashboard/lend" className="font-space text-4xl font-semibold text-light hover:-translate-y-[0.15rem] duration-150"><FontAwesomeIcon icon={faArrowUpRightFromSquare} /></Link>
          </div>
          <ExpandableCardDemo />
        </div>
      </div>
